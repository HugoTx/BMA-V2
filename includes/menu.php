...
<div
    ...
    <!--redes sociais-->
    <div class="">
        <a class="" href="https://www.facebook.com/bandadearouca" target="_blank" role="button"><i alt="logo facebook"
                class=" bi bi-facebook" style="color:aliceblue"></i></a>
        ...
        <a class="ms-2" href="https://www.bandadearouca.com" target="_blank" role="button"><i class=" bi bi-globe"
