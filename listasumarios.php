    ...
    <div id="back">
                                ...
                                <div class="container w-50">
                                    <div class="form-group mt-4">
                                        <form action="" method="POST">
                                            ...
                                            <div class="mb-1 mt-1"> Data Final </div><input type="date"
                                                class="form-group" id="dataFim" name="dataFim">
                                            <div class="mb-1 mt-1">
                                ...
                                <div class="container w-50">
                                    <div class="form-group mt-4">
                                        <form action="" method="POST">
                                            ...
                                            <div class="mb-1 mt-1"> Data Final </div><input type="date"
                                                class="form-group" id="dataFimAluno" name="dataFim">
                                            <div class="mb-1 mt-1">
        ...
        <div class="container w-100 mt-4 mb-4 d-none" id="table_sumario_faltas">
            ...
            <div class="d-flex flex-row-reverse">
                <button onclick="exportTableToExcel('novaPesquisa', 'sumarios')" class="btn btn-outline-primary ml-3"
